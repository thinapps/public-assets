...
Normal country, subdivision, and city additions, removals, renames, and path changes should be made in the private source place tree first. Region membership in `place_photos/world.json` is maintained separately. Manual edits to generated public files should be limited to deliberate repairs.
